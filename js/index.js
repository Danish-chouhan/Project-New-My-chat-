...
document.querySelector(".currentTime").innerText =
  time.toLocaleTimeString("en-US", options1);
// week
const week = new Date();
const options2 = { weekday: "short" };
document.querySelector(".currentWeek").innerText =
  week.toLocaleDateString("en-US", options2);

// date-month
const m_d = new Date();
const options3 = { month: "short", day: "numeric" };
document.querySelector(".currentMonth").innerText =
  m_d.toLocaleDateString("en-US", options3);
...
const supportContainer = document.getElementById(
  "MainContainerOfSupport"
);
...
const mainContainerOfSetting =
  document.getElementById("containerSetting");
...
const navigationBar = document.getElementById("Header-container")

const navBtn = document.getElementById("navMobile")
navBtn.addEventListener('click',()=>{
  navigationBar.classList.remove("ActiveOfNav")
})
